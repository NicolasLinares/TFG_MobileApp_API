...
class CreateAudioTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('audio', function (Blueprint $table) {
            ...
            $table->string('localpath')->unique('localpath')->comment('Dirección donde se encuentra almacenado el audio');
            ...
            $table->integer('id_transcript')->index('id_transcript')->nullable()->comment('Transcripción asociada al audio');
